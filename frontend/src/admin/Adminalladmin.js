...
useEffect(()=>{ 
   ...
   const res = await axios.get('/api/hotel/getalladmin');
...
setLoading(true)
     ...
     try{
         ...
         const res = await axios.delete(`/api/hotel/deleteadmin/${id}`);
              ...
              <div className="col-md-3 bg-light">
               ...
               <div className="container">
                        ...
                        <div className="mains" style={{marginTop:'20px'}}>
                            ...
                            <span style={{fontWeight:'bold',fontSize:'20px'}}>All Admin</span>

                           <span style={{float:'right',marginRight:'10%'}}> <Link to="/admin_add_admin" className="btn btn-success">Add Admin</Link></span>
